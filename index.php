...
<header class="hero bg-dark text-white text-center">
  <div class="container">
    <h1 class="display-3 fw-bold">Welcome to WE CRUNCH!</h1>
    <p class="lead">Taste the Best. Love Every Bite.</p>
